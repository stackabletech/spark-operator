...
docker:
	docker build --force-rm -t "docker.stackable.tech/stackable/spark-operator:${TAG}" -t "docker.stackable.tech/stackable/spark-operator:latest" -f docker/Dockerfile .
